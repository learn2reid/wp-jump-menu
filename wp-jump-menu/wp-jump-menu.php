...
class WpJumpMenu {
	...
	public string $menu_cache_label;
	public string $menu_refresh_cache_label;
	...
	public function __construct() {
		...
		// set text domain
		load_plugin_textdomain( 'wp-jump-menu', false, basename( __DIR__ ) . '/languages' );
	 ...
	 * @created: 03/20/2016
	 */
	public function clear_local_storage( $post_id, $post, $update ) {
	...
	public function clear_local_storage_after_media_upload( $file ) {
		set_transient( $this->menu_refresh_cache_label, 1 );
		return $file;
	}
	 ...
	 */
	public function ajax_clear_local_storage() {
		set_transient( $this->menu_refresh_cache_label, 1 );
		wp_die();
	}
	 ...
	 */
	public function ajax_clear_local_storage_script() {
		?>
	<script>
	 ...
	 * @created: 12/12/12
	 **/
	public function wpjm_admin_scripts() {
		// jquery ui - sortable
	...
	public function wpjm_frontend_scripts() {
	}

	public function wpjm_scripts() {
	...
	public function wpjm_settings_scripts() {
		// Colorpicker
	 ...
	 * @created: 12/12/12
	 **/
	public function wpjm_options_page() {
	 ...
	 * @created: 12/12/12
	 **/
	public function wpjm_page_dropdown( $cached = false ) {
	 ...
	 * @return string
	 */
	public function wpjm_get_page_title( $pd_title ) {
...
if ( function_exists( 'current_user_can' ) && ! is_network_admin() ) {
